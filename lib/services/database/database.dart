...
Future<bool> databaseNeedsReset() async {
  ...
  print(
    'Current database version: (mugiten: $mugitenVersion, jadb: $jadbVersion)',
  );
  print(
    'Expected database version: (mugiten: $mugitenSchemaVersion, jadb: $jadbSchemaVersion)',
  );
  ...
  print('No database reset needed');
